                ...
                <ul class="nav side-menu">
                            ...
                            <ul class="nav child_menu">
                                @if (canRoute('admin.package-projects.index'))
                                    <li><a href="{{ route('admin.package-projects.index') }}"><i
                                                class="fa fa-archive"></i> Create Packages</a></li>
                                @endif
                                @if (canRoute('admin.procurement-details.index'))
                                ...
                                @if (canRoute('admin.contracts.index'))
                                    <li><a href="{{ route('admin.contracts.index') }}"><i class="fa fa-list"></i>
                                            Manage Contracts</a></li>
                                @endif
                                @if (canRoute('admin.package-project-assignments.index'))
                                    <li><a href="{{ route('admin.package-project-assignments.index') }}"><i
                                                class="fa fa-list"></i> Assignments</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
                            ...
                            <ul class="nav child_menu">
                                ...
                                @if (canRoute('admin.physical_boq_progress.index'))
                                    <li><a href="{{ route('admin.physical_boq_progress.index') }}"><i
                                                class="fa fa-cubes"></i> Physical BOQ Progress</a></li>
                                @endif
                        ...
                        <li class="{{ request()->routeIs('admin.boqentry.*') ? 'active' : '' }}">
                            ...
                            <ul class="nav child_menu">
                                @if (canRoute('admin.boqentry.index'))
                                    <li><a href="{{ route('admin.boqentry.index') }}"><i class="fa fa-list"></i> List
                                            BOQ</a></li>
                                @endif
                                @if (canRoute('admin.boqentry.create'))
                                    <li><a href="{{ route('admin.boqentry.create') }}"><i
                                                class="fa fa-plus-circle"></i> Create BOQ</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
                    ...
                    @if (canRoute('admin.epcentry_data.index') ||
                        ...
                        <li
                            ...
                            <ul class="nav child_menu">
                                @if (canRoute('admin.epcentry_data.index'))
                                    <li><a href="{{ route('admin.epcentry_data.index') }}"><i class="fa fa-list"></i>
                                            EPC Entries</a></li>
                                @endif
                                @if (canRoute('admin.epcentry_data.create'))
                                    <li><a href="{{ route('admin.epcentry_data.create') }}"><i
                                                class="fa fa-plus-circle"></i> Add EPC</a></li>
                                @endif
                        ...
                        <li
                            ...
                            <ul class="nav child_menu">
                                ...
                                @if (canRoute('admin.roles.index'))
                                    <li><a href="{{ route('admin.roles.index') }}"><i class="fa fa-id-badge"></i>
                                            Roles</a></li>
                                @endif
                                ...
                                @if (canRoute('admin.projects-category.index'))
                                    <li><a href="{{ route('admin.projects-category.index') }}"><i
                                                class="fa fa-tags"></i> Project Categories</a></li>
                                @endif
                        ...
                        <li class="{{ request()->routeIs('admin.media.*') ? 'active' : '' }}">
                            ...
                            <ul class="nav child_menu">
                                ...
                                @if (canRoute('admin.media.gallery'))
                                    <li><a href="{{ route('admin.media.gallery') }}"><i class="fa fa-images"></i>
                                            Gallery</a></li>
                                @endif
                            </ul>
                        </li>
                    ...
                    @if (canRoute('admin.project.index'))
                        <li class="{{ request()->routeIs('admin.project.*') ? 'active' : '' }}">
                            ...
                            <ul class="nav child_menu">
                                <li><a href="{{ route('admin.project.index') }}"><i class="fa fa-tasks"></i>
                                        Projects</a></li>
                            </ul>
                        </li>
                    @endif
                    ...
                    @if (canRoute('admin.pages.list') ||
                        ...
                        <li
                            class="{{ request()->routeIs('admin.pages.*') || request()->routeIs('admin.navbar-items.*') || request()->routeIs('admin.slides.*') || request()->routeIs('admin.leaders.*') || request()->routeIs('admin.videos.*') ? 'active' : '' }}">
                            ...
                            <ul class="nav child_menu">
                                ...
                                @if (canRoute('admin.slides.index'))
                                    <li><a href="{{ route('admin.slides.index') }}"><i class="fa fa-file-alt"></i>
                                            Slides Management</a></li>
                                @endif
                                @if (canRoute('admin.leaders.index'))
                                    <li><a href="{{ route('admin.leaders.index') }}"><i class="fas fa-user-tie"></i>
                                            Leaders Management</a></li>
                                @endif
                                @if (canRoute('admin.videos.index'))
                                    <li><a href="{{ route('admin.videos.index') }}"><i class="fas fa-video"></i>
                                            Videos Management</a></li>
                                @endif
