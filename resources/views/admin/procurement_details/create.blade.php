            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('type_of_procurement') is-invalid @enderror"
                                ...
                                <option value="Item Wise"
                                    {{ old('type_of_procurement') == 'Item Wise' ? 'selected' : '' }}>Item Wise</option>
                                <option value="EPC" {{ old('type_of_procurement') == 'EPC' ? 'selected' : '' }}>EPC
                                </option>
                                <option value="Others" {{ old('type_of_procurement') == 'Others' ? 'selected' : '' }}>
                                    Others</option>
                            </select>
                    ...
                    <div class="row mb-4">
                     ...
                     <div class="col-md-4">
                            <p for="emd_validity_days" class="form-label h3">EMD Validity <span class="h5"> (in Days) </span> </p>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-4">
                            <p for="bid_validity_days" class="form-label h3">Bid Validity  <span class="h5"> (in Days) </span> </p>
