            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <p for="package_name" class="form-label h3">Package Name <span class="text-danger">*</span></p>
                            <textarea type="text" class="form-control" id="package_name" name="package_name"
                                value="{{ old('package_name', $packageProject->package_name) }}" required> </textarea>
                            <div class="invalid-feedback">Please provide a package name.</div>
                        </div>

                        <div class="col-md-6 mb-3">
                            <p for="package_number" class="form-label h3">Package Number <span class="text-danger">*</span></p>
                        ...
                        <div class="col-md-6 mb-3">
                            <p for="estimated_budget_incl_gst" class="form-label h3">Estimated Budget (₹) <span class="text-danger">*</span></p>
