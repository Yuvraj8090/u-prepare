        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('admin.package-projects.update', $packageProject) }}" method="POST"
                    ...
                    <!-- Basic Information -->
                    <h6 class="mb-3 text-muted border-bottom pb-2"><i class="fas fa-info-circle me-2"></i>Basic
                        Information</h6>
                    <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="{{ $approval }}_approval_date"
                                                class="form-label">Approval Date</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="{{ $approval }}_document_path"
                                                class="form-label">Approval Document (PDF)</label>
