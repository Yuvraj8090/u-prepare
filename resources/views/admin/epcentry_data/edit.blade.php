        ...
        <div class="card shadow-sm">
            <div class="card-header bg-white">
                <h5 class="mb-0 text-primary">
                    <i class="fas fa-edit me-2"></i> Edit EPC Entry: {{ $entry->subPackageProject->name }}
                </h5>
            </div>
                ...
                <form action="{{ route('admin.epcentry_data.update', $entry->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="sl_no" name="sl_no" 
                               class="form-control @error('sl_no') is-invalid @enderror"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="activity_name" name="activity_name" 
                                  class="form-control @error('activity_name') is-invalid @enderror" required>{{ old('activity_name', $entry->activity_name) }}</textarea>
                        @error('activity_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="stage_name" name="stage_name" 
                               ...
                               value="{{ old('stage_name', $entry->stage_name) }}">
                        @error('stage_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="item_description" class="form-label">Item Description (Comma Seprated) <span class="text-danger">*</span></label>
                        <textarea id="item_description" name="item_description" 
                                  class="form-control @error('item_description') is-invalid @enderror" required>{{ old('item_description', $entry->item_description) }}</textarea>
