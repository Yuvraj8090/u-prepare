<x-app-layout>
    <div class="container py-4">
        <h2 class="mb-4 fw-bold text-primary">Add EPC Entry</h2>
        ...
        <form action="{{ route('admin.epcentry_data.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea name="item_description" class="form-control @error('item_description') is-invalid @enderror" required>{{ old('item_description') }}</textarea>
