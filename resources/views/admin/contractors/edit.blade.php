            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.contractors.update', $contractor) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <x-input id="authorized_personnel_name" name="authorized_personnel_name" 
                                value="{{ old('authorized_personnel_name', $contractor->authorized_personnel_name) }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <x-input id="gst_no" name="gst_no" 
                                value="{{ old('gst_no', $contractor->gst_no) }}" 
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="address" name="address" rows="3" 
                                ...
                                placeholder="Enter company address">{{ old('address', $contractor->address) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 d-flex justify-content-end border-top pt-3">
                        ...
                        <a href="{{ route('admin.contractors.index') }}" class="btn btn-outline-danger me-2">
